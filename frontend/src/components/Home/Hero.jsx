...
const Hero = () => {
  return (
    <div className="h-[80vh] flex items-center justify-between">
      <div className="left-div w-full lg:w-[50%] flex flex-col items-center lg:items-start justify-center">
        ...
        <div className="mt-8">
        <button className="text-yellow-100 text-xl lg:text-2xl font-semibold border-1 border-yellow-100 rounded-full px-10 py-3 hover:bg-zinc-800">Discover Books</button>
        </div>
      </div>
