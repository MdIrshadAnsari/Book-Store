      ...
      <div className=" w-[25vw] bg-zinc-800 rounded-md p-5">
        <div>
          <form className="" action="">
            ...
            <textarea
              className="w-full bg-zinc-900 h-30 resize-none rounded-md text-white p-2"
              name="address"
              id="address"
            ></textarea>
          </form>
        ...
        <button className='px-3 py-2 bg-blue-500 w-full rounded-md mt-2'>Sign Up</button>
        <p className='mt-2'>Or</p>
        <p className='text-zinc-400 mt-2'>Already have an account? <a href="/">Login</a></p>
        </div>
      </div>
    </div>
  )
